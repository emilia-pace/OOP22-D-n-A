...
public class EntityFactoryImpl implements EntityFactory {
    ...
    public Entity createEntity(final Optional<MovablePlatform> movablePlatform, final EntityType type, final Position2d... position) {
        return switch (type) {
            ...
            case RED_PUDDLE -> new Puddle(position[0], (double)PUDDLE_HEIGHT,(double)PUDDLE_WIDTH, Entity.EntityType.RED_PUDDLE);
            case BLUE_PUDDLE ->
            ...
            case DIAMOND -> new Diamond((double)DIAMOND_HEIGHT, (double)DIAMOND_WIDTH, DIAMOND_VALUE, position[0]);
